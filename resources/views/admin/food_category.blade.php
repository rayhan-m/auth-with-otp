...
@section('mainContent')
    ...
    <div class="mt-20 mb-20">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"> <span>+</span> Food Category</button>
    </div>
                ...
                <div class="row mb-4">
                                            ...
                                            @foreach ($data as $item)
                                                <tr>
                                                    ...
                                                    <td>@if ($item->active_status==1)
                                                        <a href="{{ url('admin/category-deactive/'.$item->id)}}"> <label class="badge badge-info">Active</label></a>
                                                        @else
                                                          <a href="{{ url('admin/category-active/'.$item->id)}}"> <label class="badge badge-danger">Deactive</label></a>
                                                        @endif</td>
                                                ...
                                                <div class="modal fade" id="editModal{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-2" aria-hidden="true">
                                                  ...
                                                  <div class="modal-header">
                                                      <h5 class="modal-title" id="exampleModalLabel-2">Edit Food Category</h5>
                                                          ...
                                                          <div class="col-lg-10 col-lg-offset-1" style="margin-left: 40px;">
                                                              <div class="input-effect">
                                                                <label>Category Name</label>
                                                                  ...
                                                                  <input class="primary-input form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" type="text" name="name" placeholder="Category Name" value="{{ $item->name}}" autocomplete="off">
                  ...
                  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-2" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel-2">Food Category</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <form method="POST" action="{{route('food_category_submit')}}" enctype="multipart/form-data">
                          @csrf 
                          <div class="modal-body">
                            <div class="row mb-20">
                              <div class="col-lg-10 col-lg-offset-1" style="margin-left: 40px;">
                                  <div class="input-effect">
                                    <label>Category Name</label>
                                      <input class="primary-input form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" type="text" name="name" placeholder="Category Name"autocomplete="off">
                                      <span class="focus-border"></span> @if ($errors->has('name'))
                                      <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('name') }}</strong>
                                </span> @endif
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mt-20 d-flex justify-content-between">
                                    ...
                                    <form action="{{url('admin/category-delete/'.$item->id)}}" method="DELETE" enctype="multipart/form-data"
                                      >
