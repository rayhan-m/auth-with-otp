...
@section('mainContent')
    ...
    <div class="breadcrumb">
        <ul>
            <li><a href="#">Milk Store</a></li>
            <li>Milk Buyer List</li>
        </ul>
    </div>
    <div class=" border-top"></div>
    <div class="mt-20 mb-20">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"> <span>+</span> Milk Buyer</button>
    </div>
                ...
                <div class="row mb-4">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data as $item)
                                                <tr>
                                                    ...
                                                    <td>{{$item->email}}</td>
                                                    <td>{{$item->address}}</td>
                                                    <td style="text-align:center;"> <img height="80px;" width="80px;"  src="{{ file_exists(@$item->image) ? asset(@$item->image) : asset('public/backend/uploads/staff/customer.png') }}" class="img img-fluid">  </td>
                                                    <td> 
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                      <div class="modal-content">
                                                        <div class="modal-header">
                                                          <h5 class="modal-title" id="exampleModalLabel-2">Edit Milk Buyer Info</h5>
                                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                          </button>
                                                        </div>
                                                        <form method="POST" action="{{route('milk_buyer_update')}}" enctype="multipart/form-data">
                                                          @csrf 
                                                            ...
                                                            <div class="row mb-20">
                                                              <div class="col-lg-10 col-lg-offset-1" style="margin-left: 40px;">
                                                                    ...
                                                                    <div class="input-effect mt-20">
                                                                        ...
                                                                        name="phone" id="phone_no_edit" value="{{@$item->phone}}" autocomplete="off">
                                                                    ...
                                                                    <div class="form-group">
                                                                      <img class="mb-20" height="80px;" width="80px;"  src="{{asset('/')}}{{$item->image}}" class="img img-fluid">
                                                          ...
                                                          <div class="modal-content">
                                                              ...
                                                              <div class="modal-body">
                                                                  <div class="text-center">
                                                                      <h4>Are You Sure To Delete Buyer ?</h4>
                                                                  </div>
                                                                  <div class="mt-20 d-flex justify-content-between">
                                                                      <button type="button" class="btn btn-info" data-dismiss="modal">Cancel</button>
                                                                      <a href="{{url('admin/milk-buyer-delete/'.$item->id)}}"><button class="btn btn-danger" >Delete</button></a>
                                                                      </form>
                  ...
                  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-2" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel-2">Buyer Info</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <form method="POST" action="{{route('milk_buyer_submit')}}" enctype="multipart/form-data">
                          @csrf 
                          <div class="modal-body">
                            <div class="row mb-20">
                              <div class="col-lg-10 col-lg-offset-1" style="margin-left: 40px;">
